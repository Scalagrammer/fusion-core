...
import scg.fusion.cglib.reflect.DuplicatesPredicate;
...
import static scg.fusion.cglib.core.Constants.SOURCE_FILE;

public class Enhancer extends AbstractClassGenerator {

    // TODO: remove all factory logic
    ...
    private static final Type FACTORY =
            TypeUtils.parseType("scg.fusion.cglib.proxy.Factory");
    ...
    private static final Type CALLBACK =
            TypeUtils.parseType("scg.fusion.cglib.proxy.Callback");
    ...
    public void setExecutionInterceptorCallbackType() {
        setCallbackTypes(new Class<?>[] { ExecutionInterceptor.class });
    }
