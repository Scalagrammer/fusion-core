...
import scg.fusion.cglib.reflect.FastClass;
...
public class MethodProxy {
    ...
    public static MethodProxy find(Class type, Signature sig) {
        try {
            Method m = type.getDeclaredMethod(ExecutionInterceptorGenerator.FIND_PROXY_NAME,
                    ExecutionInterceptorGenerator.FIND_PROXY_TYPES);
     ...
     * @see ExecutionInterceptor#intercept
